...
export const addFlashSaleApi = toMutationFetcher<
  TAddFlashSaleRequestParams,
  TServerResponse<TFlashSale>
>("addFlashSaleApi", async (params) => {
...
>("getAllFlashSaleListByBrandIdApi", async (params) => {
  return privateRequest(
    `/product-discount/get-product-discount-of-brand/${params?.brandId}`,
    {
      method: "GET",
      params,
    }
...
export const getAllFlashSaleApi = toQueryFetcher<
  void,
  TServerResponse<TFlashSale[]>
>("getAllFlashSaleApi", async () => {
  return privateRequest("/product-discount", {
    method: "GET",
  });
});
