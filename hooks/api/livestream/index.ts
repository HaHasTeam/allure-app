...
export const getListLiveStreamApi = toQueryFetcher<LivestreamFilterParams, TServerResponse<LivestreamResponse[]>>(
...
export const getActiveLiveStreamApi = toQueryFetcher<LivestreamFilterParams, TServerResponse<LivestreamResponse[]>>(
  'getListLiveStreamApi',
  async (params) => {
...
export const getLiveStreamById = toQueryFetcher<string, TServerResponse<LivestreamResponse>>(
  'getLiveStreamById',
  async (params) => {
...
export const getLiveStreamByIdMutation = toMutationFetcher<string, TServerResponse<LivestreamResponse>>(
...
export const getCustomTokenLivestreamApi = toMutationFetcher<TokenRequestParams, TServerResponse<string>>(
