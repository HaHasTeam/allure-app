...
import { errorMessage, SLOT_NUMBER, WEEKDAY } from '@/constants/index'
...
let globalShowToast: (message: string, type?: ToastType, duration?: number) => void

// Function to set the global toast function
export function setGlobalToast(showToastFn: (message: string, type?: ToastType, duration?: number) => void) {
