 ...
 */
export const showErrorAlert = (error: any, title = 'Error', actions: AlertAction[] = []): void => {
 ...
 */
export const showNetworkErrorAlert = (error: any, retryAction: () => void, cancelAction?: () => void): void => {
  const errorMessage = resolveError(error)
 ...
 * @param cancelAction Optional function to call when user cancels
 */
export const showAuthErrorAlert = (error: any, loginAction: () => void, cancelAction?: () => void): void => {
  const errorMessage = resolveError(error)
 ...
 */
export const showPermissionErrorAlert = (error: any, goBackAction: () => void): void => {
  const errorMessage = resolveError(error)
