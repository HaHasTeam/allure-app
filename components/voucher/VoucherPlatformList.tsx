...
import { getCheckoutListPlatformVouchersApi } from '@/hooks/api/voucher'
...
import { ICheckoutItem, IPlatformBestVoucher, IVoucherUI, TVoucher } from '@/types/voucher'
    ...
    try {
      if (checkoutItems && checkoutItems?.length > 0) {
        ...
        await callPlatformVouchersFn({
          ...
          brandItems: selectedCheckoutItems && selectedCheckoutItems?.length > 0 ? selectedCheckoutItems : checkoutItems
        })
      }
    } catch (error) {
      ...
      >
        ...
        <BottomSheetView style={styles.contentContainer}>
          <View>
            ...
            <Text style={styles.sheetDescription}>{t('voucher.description')}</Text>
              ...
              <View>
                ...
                {selectedCartItems?.length === 0 && (
                  <View style={styles.warningContainer}>
                    ...
                    <Text style={styles.warningText}>{t('voucher.chooseProductAppAlert')}</Text>
                  </View>
                )}
              </View>
              {/* Voucher List */}
            ...
            <View style={styles.buttonContainer}>
              <TouchableOpacity style={styles.buttonOutline} onPress={handleModalDismiss}>
                <Text style={styles.buttonOutlineText}>{t('dialog.cancel')}</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.buttonPrimary, selectedCartItems?.length === 0 && styles.buttonDisabled]}
