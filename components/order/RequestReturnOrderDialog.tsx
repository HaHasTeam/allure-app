...
export const RequestReturnOrderDialog: React.FC<
  RequestReturnOrderDialogProps
> = ({
  orderId,
  setIsTrigger,
  setIsModalVisible,
      ...
      <BottomSheetView style={styles.contentContainer}>
        ...
        <ScrollView>
          ...
          {isOtherReason && (
            <View style={styles.formField}>
              <View style={styles.fieldRow}>
                <View style={styles.labelContainer}>
                  <MyText
                    text={t("order.cancelOrderReason.otherReason")}
                    styleProps={styles.labelText}
                    required
                  />
                </View>
          ...
          <View style={styles.mediaSection}>
            <MyText
              text={t("feedback.mediaFiles")}
              styleProps={styles.sectionTitle}
              required
            />
            <MyText
              text={t("order.returnOrderDialog.mediaFilesNotes")}
            ...
            <Controller
              ...
              render={({ field, fieldState: { error } }) => (
                <View style={styles.uploadField}>
                  <MyText
                    text={t("feedback.uploadVideos")}
                    styleProps={styles.uploadLabel}
                    required
                  />
                  <UploadMediaFiles
                    field={field}
