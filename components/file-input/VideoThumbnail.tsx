    ...
    <TouchableOpacity style={[styles.container, style]} onPress={onPress}>
      {thumbnail ? (
        ...
        <View style={styles.thumbnailContainer}>
          <ImageWithFallback source={{ uri: thumbnail }} style={styles.thumbnailImage} resizeMode='cover' />
  ...
  return (
    <TouchableOpacity style={[styles.container, style]} onPress={onPress}>
      {thumbnail ? (
        // Show the actual thumbnail with play button overlay
        <View style={styles.thumbnailContainer}>
          <ImageWithFallback source={{ uri: thumbnail }} style={styles.thumbnailImage} />
          <View style={styles.overlay}>
            <Feather name='play-circle' size={40} color='white' />
          </View>
        </View>
        ...
        <View style={styles.fallbackContainer}>
          {isLoading ? (
            <View style={styles.loadingContainer}>
              <Feather name='play-circle' size={40} color={`${myTheme.primary}99`} />
            </View>
          ) : (
            // Video poster fallback if thumbnail generation failed
            <View style={styles.thumbnailContainer}>
              <VideoView style={styles.thumbnailImage} player={player} allowsFullscreen allowsPictureInPicture />
              <View style={styles.overlay}>
                <Feather name='play-circle' size={40} color='white' />
              </View>
            </View>
