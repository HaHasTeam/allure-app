...
export const FileUploaderContent = ({
  ...
  return (
    <View
      ...
      ref={containerRef}
      accessibilityLabel="content file holder"
    >
      <View
        {...props}
        style={[
...
export const FileUploaderItem = ({
  ...
  const { removeFileFromSet, activeIndex, direction, getPreviewUrl } =
    useFileUpload();
  ...
  return (
    <View
      style={[styles.item, style, isSelected && styles.selectedItem]}
      {...props}
    >
      ...
      <View
        style={[
          styles.itemActions,
          direction === "rtl" ? styles.actionsRtl : styles.actionsLtr,
        ]}
      >
...
export const FileInput = ({
  ...
  return (
    <View
      {...props}
      style={[styles.fileInputContainer, isDisabled && styles.disabled, style]}
    >
      <TouchableOpacity
...
export const ProductFileUploaderItem = ({
  ...
  return (
    <View
      style={[styles.productItem, style, isSelected && styles.selectedItem]}
      {...props}
    >
      ...
      <TouchableOpacity
        style={[
          styles.removeButton,
          direction === "rtl" ? styles.removeButtonRtl : styles.removeButtonLtr,
        ]}
