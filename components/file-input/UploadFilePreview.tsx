...
const UploadFilePreview = <T extends FieldValues>({
  ...
  const message = `You can upload up to ${
    dropZoneConfig.maxFiles
  } files. Accepted file formats are ${Object.values(dropZoneConfig.accept)
    .flat()
    .join(", ")}. Each file must be under ${
    dropZoneConfig.maxSize / (1024 * 1024)
  }MB.`;
              ...
              >
                ...
                {isDragActive ? (
                  <MyText
                    ...
                    styleProps={styles.dragActiveText}
                  />
                ) : (
                  <View>
                    <MyText
                        ...
                        >
                          {renderFileItemUI ? (
                            ...
                            >
                              ...
                              <MyText
                                text={file.name}
                                styleProps={styles.fileNamePreview}
                              />
                            </TouchableOpacity>
                          )}
                          <PreviewDialog
                            ...
                            contentType={
                              file.type?.includes("image") ? "image" : undefined
                            }
                          />
                        </FileUploaderItem>
                      ))}
