...
export function PreviewDialog({ content, contentType, style, isVisible, onDismiss }: PreviewDialogProps) {
    ...
    if (contentType === 'image' && typeof content === 'string') {
      return (
        <View style={styles.mediaContainer}>
          <ImageWithFallback source={{ uri: content }} style={styles.image} resizeMode='contain' />
        </View>
      )
    } else if (contentType === 'video' && typeof content === 'string' && player) {
      return (
        <View style={styles.mediaContainer}>
