...
export default function LoadingIcon({ size = 'medium', color = 'primary', label, style }: LoadingSpinnerProps) {
  const sizeMap: Record<'small' | 'medium' | 'large', number | 'small' | 'large'> = {
    small: 'small',
    medium: 'large',
    large: 50
  }
