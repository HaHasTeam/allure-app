    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
          ...
          <View style={styles.statsContainer}>
            ...
            {product.soldInPastMonth > 0 && (
              <Text style={styles.soldText}>
                {formatNumber(product.soldInPastMonth)} sold
              </Text>
            )}
          </View>
            ...
            {hasDiscount ? (
              <>
                <Text style={styles.discountedPrice}>
                  {t("productCard.price", { price: displayDiscountedPrice })}
                </Text>
                <Text style={styles.originalPrice}>
                  {t("productCard.price", { price: displayOriginalPrice })}
                </Text>
              </>
            ) : (
        ...
        <View style={styles.actionsContainer}>
          <View
            style={[styles.buttonGroup, { backgroundColor: myTheme.primary }]}
          >
            <TouchableOpacity
            ...
            <TouchableOpacity
              ...
              onPress={() => onBuyNow(product as any)}
            >
              <Text
                style={[
