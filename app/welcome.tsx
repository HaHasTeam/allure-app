...
import { ImageBackground, StyleSheet, Dimensions, View as RNView } from 'react-native'
      ...
      <RNView style={styles.overlay}>
        <View style={styles.content}>
          ...
          <View style={styles.buttonSection}>
            ...
            />
            <MyLink text='Đã có tài khoản? Đăng nhập' href='/login' styleProps={styles.loginLink} />
          </View>
        </View>
      </RNView>
    </ImageBackground>
